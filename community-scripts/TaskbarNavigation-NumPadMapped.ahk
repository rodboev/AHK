...
KeyListText .= "NumpadDiv	Go to previous window on taskbar`n"
KeyListText .= "NumpadMult	Go to next window on taskbar`n"
KeyListText .= "NumpadSub	Close current window (emulates Alt+F4)`n"
KeyListText .= "NumpadAdd	Switch to previous Z-order window"
...
;---------------------------------------------------------------
NumpadSub::SendInput, !{F4}

;---------------------------------------------------------------
; Switch to previous Z-order window
;---------------------------------------------------------------
NumpadAdd::SendInput, {ALTDOWN}{TAB}{ALTUP}
